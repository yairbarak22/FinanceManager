...
export default function InboxPage() {
  ...
  const filterButtons: { key: FilterType; label: string; icon: typeof Mail }[] = [
    { key: 'all', label: 'הכל', icon: Inbox },
    { key: 'unread', label: 'לא נקראו', icon: Mail },
    { key: 'starred', label: 'מסומנים', icon: Star },
    { key: 'archived', label: 'ארכיון', icon: Archive },
  ];
  ...
  return (
    <div className="h-[calc(100vh-80px)] flex flex-col">
      ...
      <div className="px-6 py-4 border-b border-[#F7F7F8]">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-[#303150]">תיבת דואר</h1>
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2.5 rounded-xl border border-[#E8E8ED] text-sm text-[#303150] placeholder-[#BDBDCB] focus:outline-none focus:border-[#69ADFF] focus:ring-2 focus:ring-[#69ADFF]/20"
            />
          </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Message List (Right) */}
        <div className="w-[400px] border-l border-[#F7F7F8] overflow-y-auto">
            ...
            <>
              {messages.map((msg) => (
                <button
                  ...
                  className={`w-full flex items-start gap-3 p-4 border-b border-[#F7F7F8] text-right transition-colors ${
        ...
        <div className="flex-1 overflow-y-auto bg-[#FAFAFA]">
          {selectedMessage ? (
            <div className="p-6">
              {/* Message header */}
              <div className="bg-white rounded-3xl p-6 mb-4 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-[#303150]">
                    ...
                    >
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <div className="flex-1">
                          <span className="text-sm font-medium text-[#303150]">
                            {msg.direction === 'outbound'
                              ? `${msg.fromEmail} → ${msg.to[0]}`
                              : getDisplayName(msg.from)}
                          </span>
                          <span className="text-[10px] text-[#BDBDCB] mr-2">
              ...
              {thread.length <= 1 && (
                <div className="bg-white rounded-3xl p-5 mb-4 shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
