...
import { Users, Check, X, Loader2, AlertTriangle, Clock } from 'lucide-react';
...
export default function InvitePage() {
  ...
  const fetchInviteInfo = useCallback(async () => {
    try {
      ...
      const res = await fetch(`/api/account/invite/info?token=${token}`);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 p-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 text-center">
          ...
          <p className="text-gray-500">טוען פרטי הזמנה...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 p-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            לא הצלחנו לטעון את פרטי ההזמנה. נסה שוב.
          </p>
          <button
  ...
  // --- Invite is valid: show landing or accept UI ---
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        {success ? (
          ...
          /* ── Not authenticated: sign-in landing ── */
          <>
            <h1 className="text-2xl font-bold text-gray-900 text-center mb-2">
              הזמנה לשיתוף חשבון
            </h1>
