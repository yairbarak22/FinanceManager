...
housing (דיור, שכר דירה, משכנתא)
  דוגמאות: בנק לאומי, בנק פועלים, בנק דיסקונט, בנק מזרחי, בנק יהב, משכנתא, שכר דירה, ועד בית, ניהול נכסים

food (מזון, סופרמרקט, מסעדות, קפה)
  דוגמאות: שופרסל, ויקטורי, רמי לוי, אושר עד, מגה, סופר פארם, מקס, קופיקס, קפה נטו, ארומה, קפה ג'ו, מקס ברנר, מסעדות, דומינוס, ברגר קינג, מקדונלד'ס, פיצה, סושי

transport (תחבורה, דלק, חניה, רכב)
  דוגמאות: פז, דור אלון, סונול, דלק, חניה, אגד, דן, רכבת ישראל, אובר, גט, מוניות, תיקון רכב, ביטוח רכב, מיסוי רכב

entertainment (בילויים, סרטים, הופעות)
  דוגמאות: סינמה סיטי, רב חן, יס פלאנט, טיימס, אירועים, הופעות, קונצרטים, תיאטרון, בילוי, פארק שעשועים

bills (חשבונות, חשמל, מים, גז)
  דוגמאות: חברת חשמל, מקורות, גז, בזק, הוט, yes, סלקום, פרטנר, פלאפון, אינטרנט, אינטרנט רימון, תשלום חשבון

health (בריאות, רופא, תרופות)
  דוגמאות: קופת חולים, כללית, מכבי, מאוחדת, לאומית, בית מרקחת, סופר פארם, נאוטרינוס, רופא, מרפאה, מרפאת שיניים, בדיקות

shopping (קניות, ביגוד, אלקטרוניקה)
  דוגמאות: זארה, H&M, קסטרו, פוקס, רנואר, רמקול, חשמל, KSP, איקאה, אייס, אלקטרוניקה, ביגוד, נעליים

education (חינוך, קורסים, ספרים)
  דוגמאות: סטימצקי, צומת ספרים, אוניברסיטה, מכללה, קורס, שיעורים פרטיים, חינוך, ספרים

subscriptions (מנויים, נטפליקס, ספוטיפיי)
  דוגמאות: נטפליקס, ספוטיפיי, אפל מיוזיק, יוטיוב פרמיום, דיסני+, HBO, מנוי, מנויים

pets (חיות מחמד, וטרינר)
  דוגמאות: וטרינר, חיות מחמד, מזון לכלבים, מזון לחתולים, פטס מרקט, פט שופ

gifts (מתנות, תרומות)
  דוגמאות: מתנות, תרומה, צדקה, עמותה, ארגון

savings (חיסכון)
  דוגמאות: קופת גמל, קרן השתלמות, ביטוח חיים, חיסכון, השקעה

personal_care (טיפוח, ספר)
  דוגמאות: ספר, מספרה, סלון, טיפוח, קוסמטיקה, פרפומריה, סופר פארם (מוצרי טיפוח)

communication (תקשורת, סלולר, אינטרנט)
  דוגמאות: בזק, סלקום, פרטנר, פלאפון, הוט, yes, אינטרנט, תקשורת

other (אחר)
  דוגמאות: העברות לא מזוהות, תשלומים כלליים

קטגוריות הכנסות זמינות:
salary (משכורת, שכר)
  דוגמאות: משכורת, שכר, תלוש משכורת, העברת משכורת

bonus (בונוס, פרס)
  דוגמאות: בונוס, פרס, מענק

investment (השקעות, דיבידנד, ריבית)
  דוגמאות: דיבידנד, ריבית, רווחי השקעה, קרן נאמנות, מניות

rental (שכירות נכס)
  דוגמאות: שכירות, שכר דירה, הכנסה משכירות

freelance (פרילנס, עבודה עצמאית)
  דוגמאות: פרילנס, עבודה עצמאית, ייעוץ, שירותים

pension (פנסיה, קצבה)
  דוגמאות: פנסיה, קצבה, ביטוח לאומי
...
כללים חשובים:
1. נסה לסווג את רוב העסקים - החזר null רק אם באמת לא ניתן לזהות (שם פרטי, העברה כללית, וכו')
2. שמות עסקים מהבנק יכולים להיות מקוצרים או מעובדים - נסה לזהות לפי מילות מפתח
3. אם שם העסק מכיל מילת מפתח ברורה (כמו "שופרסל", "דלק", "בזק") - סווג אותו בהתאם
4. שמות עמומים כמו "העברת ביט", "Paybox", "צ'ק", "העברה", שם פרטי של אדם - החזר null
5. התבסס רק על שם העסק, לא על הסכום
6. אם שם העסק מכיל מספרים או קודים בנקאיים - נסה לזהות את החלק הרלוונטי
