      ...
      lessons: [
        {
          ...
          status: 'active',
          badge: 'FREE',
          videoUrl: 'https://www.youtube.com/embed/we_4XhpK61E?rel=0&modestbranding=1&iv_load_policy=3',
        },
      ],
    },
    {
      ...
      lessons: [
        {
          ...
          status: 'active',
          badge: 'FREE',
          videoUrl: 'https://www.youtube.com/embed/oV_RElIkync?rel=0&modestbranding=1&iv_load_policy=3',
        },
      ],
    },
    {
      ...
      lessons: [
        {
          ...
          status: 'active',
          badge: 'FREE',
          videoUrl: 'https://www.youtube.com/embed/6scb7CSXIyE?rel=0&modestbranding=1&iv_load_policy=3',
        },
      ],
    },
  ],
