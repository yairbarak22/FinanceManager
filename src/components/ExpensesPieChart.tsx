...
export default function ExpensesPieChart({ transactions }: ExpensesPieChartProps) {
  ...
  if (data.length === 0) {
    return (
      <div className="card p-6 flex flex-col items-center justify-center h-full min-h-[300px]" data-tour="expenses-chart">
  ...
  return (
    <div className="card p-6" data-tour="expenses-chart">
      {/* Header */}
