...
import { Users, Mail, Shield, LogOut, ChevronDown, BarChart3, FileText, List, LayoutDashboard, Inbox, X, FolderOpen, Map, DollarSign, Workflow, CalendarClock } from 'lucide-react';
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        id: 'marketing-groups',
        label: 'קבוצות',
        path: '/admin/marketing/user-groups',
        icon: FolderOpen,
      },
      {
        id: 'marketing-logs',
